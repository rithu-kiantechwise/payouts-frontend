    ...
    return (
        <div className='container m-auto mt-16'>
            <div className='grid grid-cols-1 gap-4 text-center m-auto p-5'>
                ...
                <h4 className='text-lg'>Online payroll application that is easily affordable.</h4>
            </div>
                    ...
                    <div className=''>
                        <div className="bg-violet-500 text-center px-10 p-4 my-2">
                            <div className="text-white mb-10">
                                ...
                                <h6 className='text-sm text-gray-200'>Billed : 1 Month / 3 Months / 6 Months / 1 Year</h6>
                            </div>
                            <div>
