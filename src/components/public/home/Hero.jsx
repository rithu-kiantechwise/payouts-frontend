    ...
    <div className='lg:max-w-[80%] m-auto text-center mt-10 mb-10'>
      <div className='grid grid-cols-1 p-4 sm:p-10'>
        <div className='grid grid-cols-1 items-center'>
          <h1 className='text-center text-4xl font-bold mb-4'>Payouts crafted to build a better workplace</h1>
          <p className='text-center text-lg'>Streamline Payroll Processing with Effortless Precision.</p>
        </div>
