    ...
    return (
        <div className='mt-10'>
            <div className="max-w-[80%] m-auto">
                <h1 className='text-5xl text-center font-medium'>Affordable pricing, comprehensive features</h1>
                <div className='grid grid-cols-2 max-w-[70%] m-auto mt-20 border'>
                    <div className='grid grid-rows-2 text-center'>
                        <div className=''>
                            ...
                            <h4 className='text-sm mt-5 mb-10'>No. of employees: <strong>Up to 10</strong></h4>
                        </div>
                        <div className='border-t'>
                            <div className='flex flex-col items-start p-8 leading-[2rem] min-h-[100%]'>
                    ...
                    <div className='grid grid-rows-2 text-center border'>
                        <div className='border-t-8 border-t-violet-500'>
                            ...
                            <h4 className='text-sm mt-5 mb-10'>No. of employees: <strong>Minimum 20</strong></h4>
                        </div>
                        <div className='border-t'>
                            <div className='text-left p-8 leading-[2rem] min-h-[100%]'>
                        ...
                        <div className='p-10 leading-[2rem] min-h-[100%] bg-violet-100'>
                            <h2 className='text-lg pb-2 font-bold'>Common Payroll Features</h2>
                            <h4>&#10003;&nbsp; Automatic payroll calculation <br/> <span className='pl-4'>(Via ICICI, HSBC and YES Bank)</span></h4>
                        ...
                        <div className='flex flex-col justify-center items-start p-10 leading-[2rem] min-h-[100%] bg-violet-100'>
                            ...
                            <h4>&#10003;&nbsp; HR Integration - Zoho People</h4>
                            <h4>&#10003;&nbsp; Accounting Integration - Zoho Books</h4>
                        </div>
                </div>
            </div>
        </div>
