    ...
    <div className='mt-16'>
            <section className='grid grid-cols-2'>
                <div className='px-20 py-16'>
                    <h1 className='text-3xl font-bold leading-[2.5rem]'>Self service your employees will love</h1>
                    <h4 className='text-xl leading-[2rem] mt-4 max-w-[90%]'>Provide seamless collaboration between employees and payroll staff with a secure employee portal.</h4>
                ...
                <div className='shadow-lg'>
                    <img src={portalDashboardImage} alt="portalDashboardImage" />
                </div>
            </section>
