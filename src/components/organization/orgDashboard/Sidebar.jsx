            ...
            <div className="flex flex-col w-64 min-h-[100%] px-4 py-8 overflow-y-auto border-r rtl:border-r-0 rtl:border-l bg-gray-900 border-gray-700">
                ...
                <div className="flex flex-col justify-between flex-1 mt-6">
                    <nav>
                        ...
                        <Link className={`flex mt-6 items-center px-4 py-2 rounded-lg hover:bg-gray-800 hover:text-gray-200 ${isActive('/organization/taxation') ? 'bg-gray-800 text-gray-200' : 'text-gray-400'}`}>
                            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
