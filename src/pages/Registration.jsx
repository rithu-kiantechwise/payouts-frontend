...
const Registration = () => {
  ...
  return (
    <div className=''>
      <div className='grid grid-cols-2 max-w-[80%] m-auto mt-20'>
        <div className=''>
          <div className='mt-10'>
        ...
        <div className='text-center'>
          <div className='max-w-[75%] m-auto p-8 border-t-4 border-violet-500 shadow-xl rounded'>
            ...
            <form action="">
              ...
              <button className='text-lg bg-violet-500 text-white uppercase rounded-3xl px-20 py-2 mt-10'>Sign up now</button>
            </form>
          </div>
